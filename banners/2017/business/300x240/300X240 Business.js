...
(lib.WhiteHalf = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(118,59.7,1.282,1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.WhiteHalf, new cjs.Rectangle(-32,0,300,119.3), null);
...
(lib.RedHalf = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(118,60,1.282,1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.RedHalf, new cjs.Rectangle(-32,0,300,120), null);
...
(lib.BgYell = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(116.8,-5.1,1,1,0,0,0,117,5);
	this.instance.alpha = 0.398;

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FEE94E").s().p("AyRSwMAAAglfMAkjAAAMAAAAlfg");
	this.shape.setTransform(117.1,-120,1.282,1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.BgYell, new cjs.Rectangle(-33.9,-240,301.4,241), null);
...
// stage content:
(lib._300X240Business = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Logo copy
	this.Logo = new lib.Logo();
	this.Logo.parent = this;
	this.Logo.setTransform(122.8,82.5,0.5,0.5,0,0,0,36.5,31);
	this.Logo.alpha = 0;
	this.Logo._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Logo).wait(155).to({_off:false},0).to({scaleX:1,scaleY:1,x:97.6,y:48.3,alpha:1},5).wait(36));

	// MBC Text
	this.MBC = new lib.MBCText();
	this.MBC.parent = this;
	this.MBC.setTransform(168.1,85.1,0.5,0.5,0,0,0,41.2,15.6);
	this.MBC.alpha = 0;
	this.MBC._off = true;

	this.timeline.addTween(cjs.Tween.get(this.MBC).wait(155).to({_off:false},0).to({regX:41.1,scaleX:1,scaleY:1,x:188,y:53.4,alpha:1},5).wait(36));

	// BTN
	this.BTN = new lib.BTN();
	this.BTN.parent = this;
	this.BTN.setTransform(149,154.6,0.5,0.5,0,0,0,85.1,23.8);
	this.BTN.alpha = 0;
	this.BTN._off = true;

	this.timeline.addTween(cjs.Tween.get(this.BTN).wait(155).to({_off:false},0).to({regX:85,scaleX:1,scaleY:1,x:150,y:192.5,alpha:1},5).to({scaleX:1.2,scaleY:1.2,x:149.9,y:192.4},3).to({scaleX:1,scaleY:1,x:150,y:192.5},3).wait(30));

	// Tel
	this.Tel = new lib.Tel();
	this.Tel.parent = this;
	this.Tel.setTransform(148.9,127.4,0.5,0.5,0,0,0,74.4,10.4);
	this.Tel.alpha = 0;
	this.Tel._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Tel).wait(155).to({_off:false},0).to({scaleX:1,scaleY:1,x:149.9,y:138,alpha:1},5).wait(36));

	// Web
	this.Web = new lib.Web();
	this.Web.parent = this;
	this.Web.setTransform(148.8,109.4,0.5,0.5,0,0,0,79,8.6);
	this.Web.alpha = 0;
	this.Web._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Web).wait(155).to({_off:false},0).to({regY:8.5,scaleX:1,scaleY:1,x:149.6,y:102.1,alpha:1},5).wait(36));

	// Sesxi Text 2
	this.Sesxi = new lib.SesxiText2();
	this.Sesxi.parent = this;
	this.Sesxi.setTransform(-23.4,49.7,1,1,0,0,0,92.5,13.2);
	this.Sesxi.alpha = 0;
	this.Sesxi._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Sesxi).wait(93).to({_off:false},0).to({x:149.7,alpha:1},5).wait(52).to({y:39.7,alpha:0},5).wait(41));

	// Red Half
	this.Red = new lib.RedHalf();
	this.Red.parent = this;
	this.Red.setTransform(-150.8,60,1,1,0,0,0,117,60);
	this.Red._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Red).wait(83).to({_off:false},0).to({x:149},9).to({scaleX:1.07,x:153.8},58).to({scaleX:1,x:150},5).wait(41));

	// Red Full
	this.Red_1 = new lib.RedFull();
	this.Red_1.parent = this;
	this.Red_1.setTransform(150,0,1,1,0,0,0,117,120);
	...
	this.Money.setTransform(247.3,84.1,1,1,0,0,0,39.8,16.1);
	this.Money.alpha = 0;
	this.Money._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Money).wait(93).to({_off:false},0).to({x:148.3,alpha:1},5).wait(52).to({alpha:0},5).wait(41));

	// Sesxi Text 3
	this.Sesxi_1 = new lib.SesxiText3();
	this.Sesxi_1.parent = this;
	this.Sesxi_1.setTransform(301.5,183.6,1,1,0,0,0,65.8,26.9);
	this.Sesxi_1.alpha = 0;
	this.Sesxi_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Sesxi_1).wait(93).to({_off:false},0).to({x:113.5,y:179.7,alpha:1},5).to({_off:true},57).wait(41));

	// White Half
	this.White = new lib.WhiteHalf();
	this.White.parent = this;
	this.White.setTransform(448.9,180.2,1,1.01,0,0,0,117,59.6);
	this.White._off = true;

	this.timeline.addTween(cjs.Tween.get(this.White).wait(83).to({_off:false},0).to({regY:59.7,x:149,y:180.3},9).to({_off:true},63).wait(41));

	// Line
	this.Line = new lib.Line();
	this.Line.parent = this;
	this.Line.setTransform(303.7,120,1,1,0,0,0,4.2,120.5);
	this.Line._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Line).wait(26).to({_off:false},0).to({x:296.4},2).to({x:3.7},15).to({x:-3.6},2).to({_off:true},1).wait(150));

	// To Color Mask copy 2 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_28 = new cjs.Graphics().p("AgkSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_29 = new cjs.Graphics().p("AiFSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_30 = new cjs.Graphics().p("AjmSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_31 = new cjs.Graphics().p("AlGSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_32 = new cjs.Graphics().p("AmnSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_33 = new cjs.Graphics().p("AoISwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_34 = new cjs.Graphics().p("AppSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_35 = new cjs.Graphics().p("ArKSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_36 = new cjs.Graphics().p("AsrSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_37 = new cjs.Graphics().p("AuMSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_38 = new cjs.Graphics().p("AvtSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_39 = new cjs.Graphics().p("AxNSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_40 = new cjs.Graphics().p("AyuSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_41 = new cjs.Graphics().p("A0PSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_42 = new cjs.Graphics().p("A1wSwMAAAglfMAu3AAAMAAAAlfg");
	var mask_graphics_43 = new cjs.Graphics().p("A3RSwMAAAglfMAu3AAAMAAAAlfg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(28).to({graphics:mask_graphics_28,x:296.3,y:120}).wait(1).to({graphics:mask_graphics_29,x:286.6,y:120}).wait(1).to({graphics:mask_graphics_30,x:276.9,y:120}).wait(1).to({graphics:mask_graphics_31,x:267.3,y:120}).wait(1).to({graphics:mask_graphics_32,x:257.6,y:120}).wait(1).to({graphics:mask_graphics_33,x:247.9,y:120}).wait(1).to({graphics:mask_graphics_34,x:238.2,y:120}).wait(1).to({graphics:mask_graphics_35,x:228.5,y:120}).wait(1).to({graphics:mask_graphics_36,x:218.8,y:120}).wait(1).to({graphics:mask_graphics_37,x:209.1,y:120}).wait(1).to({graphics:mask_graphics_38,x:199.4,y:120}).wait(1).to({graphics:mask_graphics_39,x:189.8,y:120}).wait(1).to({graphics:mask_graphics_40,x:180.1,y:120}).wait(1).to({graphics:mask_graphics_41,x:170.4,y:120}).wait(1).to({graphics:mask_graphics_42,x:160.7,y:120}).wait(1).to({graphics:mask_graphics_43,x:151,y:120}).wait(1).to({graphics:null,x:0,y:0}).wait(152));

	// Sesxi Text 1
	this.Sesxi_2 = new lib.SesxiText1();
	this.Sesxi_2.parent = this;
	this.Sesxi_2.setTransform(83,43.4,1,1,0,0,0,61.4,27.9);
	...
	this.Logo_1.setTransform(253.4,37.7,1,1,0,0,0,36.5,31);
	...
	this.instance.parent = this;
	this.instance.setTransform(215.9,92.7,1,1,0,0,0,17,-17.1);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(91,158.1,1,1,0,0,0,30.8,-28.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(28).to({_off:false},0).wait(6).to({regX:30.9,scaleX:0.65,x:91.1},0).to({scaleX:1.15,scaleY:1.15,y:147.9},8).to({regX:30.8,scaleX:1,scaleY:1,x:91,y:158.1},4).to({_off:true},47).wait(103));

	// Money
	this.instance_2 = new lib.Money_2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(243.9,178.6,1,1,0,0,0,14.8,-8.8);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(219.4,178.4,1,1,0,0,0,9.6,-8.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(28).to({_off:false},0).wait(3).to({regX:9.7,regY:-8.4,scaleX:1.2,scaleY:1.2,x:222.1,y:173.4},6).to({regX:9.6,regY:-8.5,scaleX:1,scaleY:1,x:219.4,y:178.4},6).to({_off:true},50).wait(103));

	// Table
	this.instance_4 = new lib.Table();
	this.instance_4.parent = this;
	this.instance_4.setTransform(152.1,211.4,1,1,0,0,0,105.8,-24.6);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(91.6,219.6,1,1,0,0,0,14.8,-16.4);
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(166.8,165.9,1,1,0,0,0,38.5,-68.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(28).to({_off:false},0).wait(4).to({regY:0,y:234.8},0).to({regY:0.1,scaleX:1.07,scaleY:1.07,x:165.3,y:234.9},5).to({regY:0,scaleX:1,scaleY:1,x:166.8,y:234.8},7).to({_off:true},49).wait(103));

	// Bg Yell
	this.instance_7 = new lib.BgYell();
	this.instance_7.parent = this;
	this.instance_7.setTransform(150,120,1,1,0,0,0,117,-120);
	...
	this.shape_11.setTransform(244.5,94.1);
	...
	this.shape_12.setTransform(227.3,111.2);
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(211.2,191.1,0.8,0.8,0,0,0,9.7,-8.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({regX:9.6,scaleX:1,scaleY:1,x:215.4,y:166.9},5).to({y:178.4},7).wait(184));

	// PC
	this.instance_9 = new lib.PC();
	this.instance_9.parent = this;
	this.instance_9.setTransform(96,174.4,0.8,0.8,0,0,0,32.8,27.9);
	this.instance_9.alpha = 0.602;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({regY:27.8,scaleX:1,scaleY:1,x:84.1,y:144.6},5).to({y:159.1},3).to({_off:true},38).wait(150));

	// Grey Table
	this.instance_10 = new lib.GreyTable();
	this.instance_10.parent = this;
	this.instance_10.setTransform(152.1,236.1,0.8,0.8,0,0,0,105.9,0.1);
	...
	this.instance_11.parent = this;
	this.instance_11.setTransform(91.6,236,1,1,0,0,0,14.8,0);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(3).to({_off:false},0).to({regX:15,regY:0.1,scaleX:1.2,scaleY:1.2,x:91.7},5).to({regX:14.8,regY:0,scaleX:1,scaleY:1,x:91.6},3).wait(185));

	// Man Sad
	this.instance_12 = new lib.ManSad();
	this.instance_12.parent = this;
	this.instance_12.setTransform(166.8,238.3,0.855,0.855,0,0,0,38.5,0.1);
