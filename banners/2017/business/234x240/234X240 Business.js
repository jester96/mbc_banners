...
(lib.Path = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#000000").s().p("AyRAyIAAg8IP4AAQgBgEAAgGQAAgMAJgJQAIgJANAAII6AAQAMAAAJAJQAJAJAAAMQAAAFgCAFIK4AAIAAA8g");
	this.shape.setTransform(117,5.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Path, new cjs.Rectangle(0,0,234,10.1), null);
...
(lib.Path_2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AyRAyIAAg8IP5AAQgCgFAAgFQAAgMAJgJQAJgJANAAII5AAQAMAAAJAJQAJAJAAAMQAAAHgCADIK4AAIAAA8g");
	this.shape_1.setTransform(117,5.1);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Path_2, new cjs.Rectangle(0,0,234,10.1), null);
...
// stage content:
(lib._234X240Business = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.Sesxi.setTransform(-56.4,49.7,1,1,0,0,0,92.5,13.2);
	this.Sesxi.alpha = 0;
	this.Sesxi._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Sesxi).wait(93).to({_off:false},0).to({x:116.7,alpha:1},5).wait(52).to({y:39.7,alpha:0},5).wait(41));
	...
	this.timeline.addTween(cjs.Tween.get(this.Red).wait(83).to({_off:false},0).to({x:117},9).wait(104));
	...
	this.Money.setTransform(214.3,84.1,1,1,0,0,0,39.8,16.1);
	this.Money.alpha = 0;
	this.Money._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Money).wait(93).to({_off:false},0).to({x:115.3,alpha:1},5).wait(52).to({alpha:0},5).wait(41));

	// Sesxi Text 3
	this.Sesxi_1 = new lib.SesxiText3();
	this.Sesxi_1.parent = this;
	this.Sesxi_1.setTransform(268.5,183.6,1,1,0,0,0,65.8,26.9);
	this.Sesxi_1.alpha = 0;
	this.Sesxi_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Sesxi_1).wait(93).to({_off:false},0).to({x:80.5,y:179.7,alpha:1},5).to({_off:true},57).wait(41));
	...
	this.timeline.addTween(cjs.Tween.get(this.White).wait(83).to({_off:false},0).to({regY:59.7,x:117,y:180.4},9).to({_off:true},63).wait(41));
	...
	this.instance.parent = this;
	this.instance.setTransform(182.9,92.7,1,1,0,0,0,17,-17.1);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(58,158.1,1,1,0,0,0,30.8,-28.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(28).to({_off:false},0).wait(6).to({regX:30.9,scaleX:0.65,x:58.1},0).to({scaleX:1.15,scaleY:1.15,y:147.9},8).to({regX:30.8,scaleX:1,scaleY:1,x:58,y:158.1},4).to({_off:true},47).wait(103));

	// Money
	this.instance_2 = new lib.Money_2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(210.9,178.6,1,1,0,0,0,14.8,-8.8);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(186.4,178.4,1,1,0,0,0,9.6,-8.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(28).to({_off:false},0).wait(3).to({regX:9.7,regY:-8.4,scaleX:1.2,scaleY:1.2,x:189.1,y:173.4},6).to({regX:9.6,regY:-8.5,scaleX:1,scaleY:1,x:186.4,y:178.4},6).to({_off:true},50).wait(103));

	// Table
	this.instance_4 = new lib.Table();
	this.instance_4.parent = this;
	this.instance_4.setTransform(119.1,211.4,1,1,0,0,0,105.8,-24.6);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(58.6,219.6,1,1,0,0,0,14.8,-16.4);
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(133.8,165.9,1,1,0,0,0,38.5,-68.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(28).to({_off:false},0).wait(4).to({regY:0,y:234.8},0).to({regY:0.1,scaleX:1.07,scaleY:1.07,x:132.3,y:234.9},5).to({regY:0,scaleX:1,scaleY:1,x:133.8,y:234.8},7).to({_off:true},49).wait(103));

	// Bg Yell
	this.instance_7 = new lib.BgYell();
	this.instance_7.parent = this;
	this.instance_7.setTransform(117,120,1,1,0,0,0,117,-120);
	...
	this.shape_11.setTransform(211.5,94.1);
	...
	this.shape_12.setTransform(194.3,111.2);
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(178.2,191.1,0.8,0.8,0,0,0,9.7,-8.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({regX:9.6,scaleX:1,scaleY:1,x:182.4,y:166.9},5).to({y:178.4},7).wait(184));

	// PC
	this.instance_9 = new lib.PC();
	this.instance_9.parent = this;
	this.instance_9.setTransform(63,174.4,0.8,0.8,0,0,0,32.8,27.9);
	this.instance_9.alpha = 0.602;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({regY:27.8,scaleX:1,scaleY:1,x:51.1,y:144.6},5).to({y:159.1},3).to({_off:true},38).wait(150));

	// Grey Table
	this.instance_10 = new lib.GreyTable();
	this.instance_10.parent = this;
	this.instance_10.setTransform(119.1,236.1,0.8,0.8,0,0,0,105.9,0.1);
	...
	this.instance_11.parent = this;
	this.instance_11.setTransform(58.6,236,1,1,0,0,0,14.8,0);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(3).to({_off:false},0).to({regX:15,regY:0.1,scaleX:1.2,scaleY:1.2,x:58.7},5).to({regX:14.8,regY:0,scaleX:1,scaleY:1,x:58.6},3).wait(185));

	// Man Sad
	this.instance_12 = new lib.ManSad();
	this.instance_12.parent = this;
	this.instance_12.setTransform(133.8,238.3,0.855,0.855,0,0,0,38.5,0.1);
