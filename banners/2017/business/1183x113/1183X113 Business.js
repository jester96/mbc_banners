...
(lib.Cup = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(27.8,-8.5);
	...
	this.shape_2.setTransform(30.7,-8.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Cup, new cjs.Rectangle(16,-16.9,19.2,17), null);
...
(lib.Web = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AghAhQgKgNAAgTQAAgWANgOQAMgNASAAQAUAAAMAOQAMAOAAAbIg9AAQAAALAGAGQAFAGAIAAQAGAAAEgDQAEgDACgHIAYAEQgEAOgLAHQgKAHgPAAQgYAAgLgQgAgMgXQgFAGAAAKIAkAAQAAgLgFgFQgGgGgHAAQgHAAgGAGg");
	this.shape.setTransform(149.5,7.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	...
	this.shape_3.setTransform(120.6,7.8);
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgIA9QgIgDgFgIIAAANIgYAAIAAiAIAZAAIAAAvQALgNAPAAQARAAALAMQALAMAAAXQAAAYgLAMQgMAOgPAAQgIAAgHgFgAgOgFQgGAFAAAPQAAAPAEAGQAHAKAJAAQAIAAAHgHQAFgHAAgPQAAgQgFgGQgHgHgIAAQgIAAgGAHg");
	...
	this.shape_10.setTransform(47.1,11.3);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AAQAvIgQg7IgPA7IgYAAIgehdIAZAAIARA9IAQg9IAWAAIAQA9IASg9IAZAAIgfBdg");
	this.shape_11.setTransform(38.3,7.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAPAvIgPg7IgPA7IgYAAIgdhdIAXAAIASA9IAQg9IAXAAIAPA9IASg9IAYAAIgdBdg");
	this.shape_12.setTransform(24.3,7.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAQAvIgQg7IgPA7IgYAAIgehdIAZAAIARA9IAQg9IAWAAIAQA9IASg9IAZAAIgfBdg");
	this.shape_13.setTransform(10.3,7.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Web, new cjs.Rectangle(1.2,-5.7,155.5,24.1), null);
...
(lib.Tel = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ag0BPQACgQAIgOQAJgOAZgYQAUgSAEgGQAGgKABgJQAAgKgGgFQgFgGgKAAQgIAAgGAGQgFAFgCANIgdgCQACgaAPgKQANgLAVAAQAXAAAOANQANAMAAASQAAALgEAKQgEAKgIAJQgGAHgOANIgRARIgGAJIA7AAIAAAcg");
	this.shape.setTransform(142.8,7.5);
	...
	this.shape_1.setTransform(130.7,7.6);
	...
	this.shape_2.setTransform(106.3,7.6);
	...
	this.shape_3.setTransform(94.3,7.7);
	...
	this.shape_4.setTransform(69.6,7.6);
	...
	this.shape_5.setTransform(57.6,7.7);
	...
	this.shape_6.setTransform(32.7,7.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(7.1,7.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Tel, new cjs.Rectangle(-2.6,-6.5,153.9,28.6), null);
...
(lib.SesxiText3 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(187,23.4);
	...
	this.shape_1.setTransform(174.2,23.4);
	...
	this.shape_2.setTransform(164.6,23.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#D3212B").s().p("AgEALIgDgCIgEgEIgBgFIABgEIAEgDIADgDIAEgCIAFACIAEACIADAEIAAAEIAAAFIgDAEIgEACIgFABIgEgBg");
	this.shape_3.setTransform(157.2,29.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#D3212B").s().p("");
	this.shape_4.setTransform(149.7,23.4);
	...
	this.shape_5.setTransform(140.1,23.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#D3212B").s().p("");
	this.shape_6.setTransform(126.5,23.5);
	...
	this.shape_7.setTransform(113.8,23.4);
	...
	this.shape_8.setTransform(100.5,23.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#D3212B").s().p("");
	...
	this.shape_10.setTransform(78,23.4);
	...
	this.shape_11.setTransform(67.9,23.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#D3212B").s().p("");
	this.shape_12.setTransform(55.7,23.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#D3212B").s().p("");
	this.shape_13.setTransform(43.1,23.4);
	...
	this.shape_14.setTransform(158.9,-5.9);
	...
	this.shape_15.setTransform(146,-5.9);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#D3212B").s().p("AACBGIAAhnIgUAAIAAgSIAMgBQAEgBACgCIABgEIABgKIARAAIAACLg");
	this.shape_16.setTransform(137.9,-5.9);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#D3212B").s().p("");
	this.shape_17.setTransform(125.9,-5.8);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#D3212B").s().p("");
	this.shape_18.setTransform(115,-5.9);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#D3212B").s().p("");
	this.shape_19.setTransform(102.2,-5.9);
	...
	this.shape_20.setTransform(89.8,-5.9);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#D3212B").s().p("");
	this.shape_21.setTransform(75.7,-6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.SesxiText3, new cjs.Rectangle(21.2,-16.8,190.8,55.8), null);
...
(lib.SesxiText2 = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgVBbQgLgEgGgHQgHgIgFgJQgEgJAAgJIAAiMIAeAAIAAA+QAHgFAHgCIAKgBQAOAAALAEQAKAEAHAHQAGAHAEAKQACAJAAANIAAAgQAAAJgCAJQgEAJgGAIQgHAHgKAEQgLAFgOAAQgMAAgJgFgAgJgNQgFACgDAEQgDADgDAFQgBAGAAAIIAAAaQAAANAHAIQAGAHALAAQAMAAAGgHQAIgIAAgNIAAgZQgBgPgGgHQgHgIgMAAQgFAAgEABg");
	this.shape_1.setTransform(149.9,26);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(136.4,26);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(122.4,26);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(109.3,26);
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(76.7,26);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("");
	this.shape_10.setTransform(21.2,26);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.SesxiText2, new cjs.Rectangle(12.2,12.1,160.7,34.3), null);
...
(lib.SesxiText1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#B52532").s().p("");
	...
	this.shape_1.setTransform(107.2,24.5);
	...
	this.shape_2.setTransform(95.7,24.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#B52532").s().p("");
	this.shape_3.setTransform(83.8,24.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#B52532").s().p("");
	this.shape_4.setTransform(72.6,24.5);
	...
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#B52532").s().p("");
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#B52532").s().p("");
	this.shape_9.setTransform(9.2,24.6);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#B52532").s().p("");
...
(lib.Money = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#3F5B2A").s().p("");
	this.shape.setTransform(69.4,142.6);
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#7F701B").s().p("AgsBFIAAgNIARAAQgagTAAgfQAAgZAPgRQAJgJAOgEIAAgTIAMAAIAAAQIAEgBIAGAAIAAgPIAMAAIAAASQANADAIAJQAMANACAZIgPAAQAAgNgJgOQgEgFgHgEIAAAmIgMAAIAAgpIgGAAIgEAAIAAApIgMAAIAAglQgHADgEAGQgKAMAAAUQAAAXAMANQALAOATAAIAmAAIAAANg");
	this.shape_3.setTransform(22.4,140.8);
...
(lib.MBCText = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(80.4,12.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(34,12.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(15.2,12.4);
	...
	this.shape_5.setTransform(1.5,12.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.MBCText, new cjs.Rectangle(-7.2,-1.3,96.7,33.9), null);
...
(lib.BTN = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(138.5,22.9);
	...
	this.shape_1.setTransform(129.9,22.9);
	...
	this.shape_2.setTransform(120.9,22.9);
	...
	this.shape_3.setTransform(111.4,22.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#D3212B").s().p("");
	this.shape_4.setTransform(102.2,23);
	...
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#D3212B").s().p("");
	this.shape_7.setTransform(70.8,22.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#D3212B").s().p("");
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#D3212B").s().p("");
	this.shape_10.setTransform(44,22.9);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#D3212B").s().p("");
...
(lib.Mac = function(mode,startPosition,loop) {
	...
	this.shape_2.setTransform(1.5,-15.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#7CAFEB").s().p("AABASIgcgkIAuAEIAJARIgHAQg");
	this.shape_3.setTransform(8,-27.5);
	...
	this.shape_4.setTransform(2.7,-14.1);

	this.instance_1 = new lib.Path_0();
	this.instance_1.parent = this;
	this.instance_1.setTransform(7.4,-17.9,1,1,0,0,0,6.5,8.1);
	...
	this.shape_5.setTransform(4.4,-33);
	...
	this.shape_6.setTransform(4.4,-33);
	...
	this.shape_7.setTransform(7.2,-33);
	...
	this.shape_8.setTransform(7.2,-33);
...
}).prototype = getMCSymbolPrototype(lib.Mac, new cjs.Rectangle(-26.3,-57.5,64.2,57.6), null);
...
(lib.GreyCup = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(30,-8.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.GreyCup, new cjs.Rectangle(20.4,-16.9,19.2,17), null);
...
(lib.Money_2 = function(mode,startPosition,loop) {
	...
	this.instance_18.setTransform(34.9,-8.9,1,1,0,0,0,14.9,8.8);
...
}).prototype = getMCSymbolPrototype(lib.Money_2, new cjs.Rectangle(19,-19.7,37,25), null);


// stage content:
(lib._1183X113Business = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Logo copy
	this.Logo = new lib.Logo();
	this.Logo.parent = this;
	this.Logo.setTransform(164.2,93.3,0.487,0.487,0,0,0,36.5,31.2);
	this.Logo.alpha = 0;
	this.Logo._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Logo).wait(166).to({_off:false},0).to({regY:30.9,scaleX:0.97,scaleY:0.97,x:139.7,y:60,alpha:1},5).wait(34));

	// MBC Text
	this.MBC = new lib.MBCText();
	this.MBC.parent = this;
	this.MBC.setTransform(212.2,88.8,0.487,0.487,0,0,0,41.3,15.7);
	this.MBC.alpha = 0;
	this.MBC._off = true;

	this.timeline.addTween(cjs.Tween.get(this.MBC).wait(166).to({_off:false},0).to({regX:41.2,regY:15.6,scaleX:0.97,scaleY:0.97,x:231.7,y:58,alpha:1},5).wait(34));

	// BTN
	this.BTN = new lib.BTN();
	this.BTN.parent = this;
	this.BTN.setTransform(992.5,21,0.487,0.487,0,0,0,85.2,23.9);
	this.BTN.alpha = 0;
	this.BTN._off = true;

	this.timeline.addTween(cjs.Tween.get(this.BTN).wait(166).to({_off:false},0).to({regX:85,regY:23.7,scaleX:0.97,scaleY:0.97,x:993.4,y:57.8,alpha:1},5).to({regX:85.1,regY:23.8,scaleX:1.17,scaleY:1.17},3).to({regX:85.2,scaleX:1.1,scaleY:1.1,x:993.6,y:57.9},1).to({regX:85,regY:23.7,scaleX:0.97,scaleY:0.97,x:993.4,y:57.8},2).wait(28));

	// Tel
	this.Tel = new lib.Tel();
	this.Tel.parent = this;
	this.Tel.setTransform(551.8,64.4,0.487,0.487,0,0,0,74.5,10.7);
	this.Tel.alpha = 0;
	this.Tel._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Tel).wait(166).to({_off:false},0).to({regX:74.4,regY:10.5,scaleX:0.97,scaleY:0.97,x:552.7,y:74.7,alpha:1},5).wait(34));

	// Web
	this.Web = new lib.Web();
	this.Web.parent = this;
	this.Web.setTransform(551.7,46.9,0.487,0.487,0,0,0,79.1,8.8);
	this.Web.alpha = 0;
	this.Web._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Web).wait(166).to({_off:false},0).to({regX:79,regY:8.4,scaleX:0.97,scaleY:0.97,x:552.4,y:39.6,alpha:1},5).wait(34));

	// Sesxi Text 2
	this.Sesxi = new lib.SesxiText2();
	this.Sesxi.parent = this;
	this.Sesxi.setTransform(70.3,36.1,1.256,1.256,0,0,0,92.5,13.2);
	this.Sesxi.alpha = 0;
	this.Sesxi._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Sesxi).wait(93).to({_off:false},0).to({x:287.6,alpha:1},5).wait(52).to({y:23.5,alpha:0},5).wait(50));

	// Red Half
	this.Red = new lib.RedHalf();
	this.Red.parent = this;
	this.Red.setTransform(-401.9,75.5,1.644,1.256,0,0,0,117,60.1);
	this.Red._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Red).wait(83).to({_off:false},0).to({regX:117.1,x:188.9},9).to({x:188.7},58).to({scaleX:1.26,x:285.1,y:75.4},5).wait(50));

	// Red Full
	this.Red_1 = new lib.RedFull();
	this.Red_1.parent = this;
	this.Red_1.setTransform(191,-0.1,1.63,1.256,0,0,0,117.1,120);
	this.Red_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Red_1).wait(150).to({_off:false},0).to({x:781.3,y:-21.8},5).wait(50));

	// Money
	this.Money = new lib.Money();
	this.Money.parent = this;
	this.Money.setTransform(1122.4,-105.6,1.256,1.256,0,0,0,39.8,16.1);
	this.Money.alpha = 0;
	this.Money._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Money).wait(93).to({_off:false},0).to({x:998.1,alpha:1},5).wait(52).to({alpha:0},5).wait(50));

	// Sesxi Text 3
	this.Sesxi_1 = new lib.SesxiText3();
	this.Sesxi_1.parent = this;
	this.Sesxi_1.setTransform(984,81.9,1.256,1.256,0,0,0,65.8,26.9);
	this.Sesxi_1.alpha = 0;
	this.Sesxi_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Sesxi_1).wait(93).to({_off:false},0).to({x:747.9,y:77,alpha:1},5).to({_off:true},57).wait(50));

	// White Half
	this.White = new lib.WhiteHalf();
	this.White.parent = this;
	this.White.setTransform(1372.8,226.8,1.644,1.269,0,0,0,117,59.6);
	this.White._off = true;

	this.timeline.addTween(cjs.Tween.get(this.White).wait(83).to({_off:false},0).to({regX:117.1,regY:59.7,x:788.9,y:226.4},9).to({_off:true},63).wait(50));

	// Line
	this.Line = new lib.Line();
	this.Line.parent = this;
	this.Line.setTransform(1188.5,149.1,1.256,1.256,0,0,0,4.2,120.5);
	this.Line._off = true;

	this.timeline.addTween(cjs.Tween.get(this.Line).wait(26).to({_off:false},0).to({x:1178.5,y:147.2},2).to({x:4.7,y:150.6},15).to({x:-4.2},2).to({_off:true},1).wait(159));

	// To Color Mask copy 2 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_28 = new cjs.Graphics().p("AgHXjMAAAgvFMC57AAAMAAAAvFg");
	var mask_graphics_29 = new cjs.Graphics().p("AmUXjMAAAgvFMC57AAAMAAAAvFg");
	var mask_graphics_30 = new cjs.Graphics().p("AsiXjMAAAgvFMC57AAAMAAAAvFg");
	var mask_graphics_31 = new cjs.Graphics().p("AyvXjMAAAgvFMC57AAAMAAAAvFg");
	var mask_graphics_32 = new cjs.Graphics().p("A48XjMAAAgvFMC57AAAMAAAAvFg");
	var mask_graphics_33 = new cjs.Graphics().p("A/JXjMAAAgvFMC56AAAMAAAAvFg");
	var mask_graphics_34 = new cjs.Graphics().p("EglXAXjMAAAgvFMC57AAAMAAAAvFg");
	var mask_graphics_35 = new cjs.Graphics().p("EgrkAXjMAAAgvFMC57AAAMAAAAvFg");
	var mask_graphics_36 = new cjs.Graphics().p("EgxxAXjMAAAgvFMC56AAAMAAAAvFg");
	var mask_graphics_37 = new cjs.Graphics().p("Eg3/AXjMAAAgvFMC57AAAMAAAAvFg");
	var mask_graphics_38 = new cjs.Graphics().p("Eg+MAXjMAAAgvFMC57AAAMAAAAvFg");
	var mask_graphics_39 = new cjs.Graphics().p("EhEZAXjMAAAgvFMC56AAAMAAAAvFg");
	var mask_graphics_40 = new cjs.Graphics().p("EhKnAXjMAAAgvFMC57AAAMAAAAvFg");
	var mask_graphics_41 = new cjs.Graphics().p("EhQ0AXjMAAAgvFMC57AAAMAAAAvFg");
	var mask_graphics_42 = new cjs.Graphics().p("EhXBAXjMAAAgvFMC56AAAMAAAAvFg");
	var mask_graphics_43 = new cjs.Graphics().p("Ehc9AXjMAAAgvFMC57AAAMAAAAvFg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(28).to({graphics:mask_graphics_28,x:1189.2,y:85.5}).wait(1).to({graphics:mask_graphics_29,x:1149.5,y:85.5}).wait(1).to({graphics:mask_graphics_30,x:1109.7,y:85.5}).wait(1).to({graphics:mask_graphics_31,x:1070,y:85.5}).wait(1).to({graphics:mask_graphics_32,x:1030.3,y:85.5}).wait(1).to({graphics:mask_graphics_33,x:990.5,y:85.5}).wait(1).to({graphics:mask_graphics_34,x:950.8,y:85.5}).wait(1).to({graphics:mask_graphics_35,x:911.1,y:85.5}).wait(1).to({graphics:mask_graphics_36,x:871.3,y:85.5}).wait(1).to({graphics:mask_graphics_37,x:831.6,y:85.5}).wait(1).to({graphics:mask_graphics_38,x:791.9,y:85.5}).wait(1).to({graphics:mask_graphics_39,x:752.1,y:85.5}).wait(1).to({graphics:mask_graphics_40,x:712.4,y:85.5}).wait(1).to({graphics:mask_graphics_41,x:672.7,y:85.5}).wait(1).to({graphics:mask_graphics_42,x:632.9,y:85.5}).wait(1).to({graphics:mask_graphics_43,x:591.4,y:85.5}).wait(1).to({graphics:null,x:0,y:0}).wait(161));

	// Sesxi Text 1
	this.Sesxi_2 = new lib.SesxiText1();
	this.Sesxi_2.parent = this;
	this.Sesxi_2.setTransform(162.7,56.8,1.256,1.256,0,0,0,61.4,28);
	...
	this.Logo_1.setTransform(1062,58.6,1.256,1.256,0,0,0,36.5,31.1);
	...
	this.instance.parent = this;
	this.instance.setTransform(677.7,17.7,1.044,1.044,0,0,0,17.1,-16.9);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(518.2,77.2,0.939,0.939,0,0,0,30.9,-28.7);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(28).to({_off:false},0).wait(6).to({regX:31,scaleX:0.61,x:518.3},0).to({regX:30.9,regY:-28.6,scaleX:1.08,scaleY:1.08,x:518.2,y:67.6},8).to({regY:-28.7,scaleX:0.94,scaleY:0.94,y:77.2},4).to({_off:true},47).wait(112));

	// Money
	this.instance_2 = new lib.Money_2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(661.9,96.4,0.939,0.939,0,0,0,15,-8.7);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(28).to({_off:false},0).to({regX:14.9,scaleX:1.32,scaleY:1.32,y:88.5},9).to({regX:15,scaleX:0.94,scaleY:0.94,y:96.4},6).to({_off:true},50).wait(112));

	// Cup
	this.instance_3 = new lib.Cup();
	this.instance_3.parent = this;
	this.instance_3.setTransform(638.9,96.4,0.939,0.939,0,0,0,9.8,-8.3);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(28).to({_off:false},0).wait(3).to({regX:9.9,scaleX:1.13,scaleY:1.13,x:641.4,y:91.6},6).to({regX:9.8,scaleX:0.94,scaleY:0.94,x:638.9,y:96.4},6).to({_off:true},50).wait(112));

	// Table
	this.instance_4 = new lib.Table();
	this.instance_4.parent = this;
	this.instance_4.setTransform(596.7,127.4,5.625,0.939,0,0,0,106.1,-24.4);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(589.4,84.5,0.939,0.939,0,0,0,38.6,-68.7);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(28).to({_off:false},0).wait(4).to({regY:0.3,y:149.4},0).to({scaleX:1,scaleY:1,x:588.1},5).to({scaleX:0.94,scaleY:0.94,x:589.4},7).to({_off:true},49).wait(112));

	// Bg Yell
	this.instance_6 = new lib.BgYell();
	this.instance_6.parent = this;
	this.instance_6.setTransform(593.5,-168.9,5.085,3.918,0,0,0,117,-120);
	...
	this.shape_11.setTransform(706.9,19.8,1.005,1.005);
	...
	this.shape_12.setTransform(689.6,37.1,1.005,1.005);
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(631.4,104.3,0.732,0.732,0,0,0,9.7,0.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:9.8,regY:0.1,scaleX:1.1,scaleY:1.1,x:639.2,y:93.8},5).to({regX:9.7,scaleX:0.92,scaleY:0.92,x:634.9,y:97.7},3).to({x:635.4,y:104.6},3).to({_off:true},185).wait(9));

	// PC
	this.instance_8 = new lib.PC();
	this.instance_8.parent = this;
	this.instance_8.setTransform(526,104.3,0.732,0.732,0,0,0,32.9,55.9);
	this.instance_8.alpha = 0.602;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({regY:55.7,scaleX:1.1,scaleY:1.1,x:505.3,y:104.2},5).to({regX:32.8,regY:55.6,scaleX:0.92,scaleY:0.92,x:515.2,y:104},3).to({_off:true},38).wait(159));

	// Grey Table
	this.instance_9 = new lib.GreyTable();
	this.instance_9.parent = this;
	this.instance_9.setTransform(594.5,149.2,5.624,0.915,0,0,0,106,0.1);
	...
	this.instance_10.parent = this;
	this.instance_10.setTransform(590.9,143.5,0.783,0.783,0,0,0,38.7,0.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({regX:38.8,scaleX:1.14,scaleY:1.14,x:596.2,y:157.8},5).to({regX:38.6,regY:0.1,scaleX:0.92,scaleY:0.92,x:590.9,y:147.1},3).to({_off:true},38).wait(159));

	// Bg Yell copy
	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#DEDEDE").s().p("EhHbAI1IAAxpMCO3AAAIAARpg");
	this.shape_22.setTransform(593.4,73.6,1.301,1.302);

	this.timeline.addTween(cjs.Tween.get(this.shape_22).to({_off:true},46).wait(159));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(589.9,56.5,1190,149.1);
// library properties:
lib.properties = {
